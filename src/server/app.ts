...
- قاعدة صارمة (مهم جداً): إذا كان السياق يحتوي على صالون محدد (salonId موجود) والمستخدم يرسل كلمات تأكيد أو حجز مثل "الحجز"، "احجز"، "تأكيد"، "نعم"، أو يذكر اسم خدمة مثل "صبغ"،禁止 استدعاء search_salons مطلقاً. بدلاً من ذلك، احتفظ بالصالون النشط واسأل المستخدم فقط عن البيانات الناقصة (التاريخ والوقت والخدمة) مباشرة.
