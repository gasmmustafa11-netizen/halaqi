...
const AdminVerifiedBadge = () => {
  ...
  return (
    <div ref={ref} className="relative inline-flex shrink-0">
      ...
      {open && (
        <div
          className="fixed left-1/2 top-20 z-[9999] w-[calc(100vw-24px)] max-w-[300px] -translate-x-1/2 rounded-xl border border-white/10 bg-[#111111]/98 px-3 py-2.5 text-center text-[11px] font-medium leading-5 text-gray-200 shadow-2xl backdrop-blur-xl"
        >
...
const PublicUserProfileView: React.FC<PublicUserProfileViewProps> = ({
  userId,
  onBack,
}) => {
