...
export const PublicUserProfileView: React.FC<PublicUserProfileViewProps> = ({
  ...
  <div className="relative inline-flex items-center">
    ...
    <div
      ...
      className="hidden absolute top-7 right-0 z-50 w-max max-w-[260px] rounded-lg border border-white/10 bg-[#111111]/95 px-3 py-2 text-[11px] leading-5 text-gray-200 shadow-xl backdrop-blur-2xl"
    >
