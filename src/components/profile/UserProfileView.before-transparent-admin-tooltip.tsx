...
const AdminVerifiedBadge = () => {
  ...
  return (
    <div ref={ref} className="relative inline-flex shrink-0">
      ...
      {open && (
        <div
          className="fixed left-1/2 top-20 z-[9999] w-[calc(100vw-24px)] max-w-[300px] -translate-x-1/2 rounded-xl border border-white/10 bg-black/35 px-3 py-2.5 text-center text-[11px] font-medium leading-5 text-gray-200 shadow-[0_12px_40px_rgba(0,0,0,0.35)] backdrop-blur-2xl"
        >
