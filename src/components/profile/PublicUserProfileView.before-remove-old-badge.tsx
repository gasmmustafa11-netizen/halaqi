            ...
            <div className="flex-1 pt-1 sm:pb-2">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {user.role === 'admin' && (
                  <button
                    type="button"
                    title="هذا الحساب موثّق رسميًا من حلاقي ويتمتع بمزايا خاصة."
                    aria-label="حساب موثّق رسميًا من حلاقي ويتمتع بمزايا خاصة"
                  ...
                  >
                    ...
                    >
                      <path
                        fill="#1877F2"
                        d="M12 1.8l2.05 1.35 2.42-.18 1.35 2.05 2.25.91-.18 2.42L21.2 12l-1.31 2.05.18 2.42-2.05 1.35-.91 2.25-2.42-.18L12 22.2l-2.05-1.31-2.42.18-1.35-2.05-2.25-.91.18-2.42L2.8 12l1.31-2.05-.18-2.42 2.05-1.35.91-2.25 2.42.18L12 1.8z"
                      />
                      <path
                ...
                {user.role === 'admin' && (
                  <span className="relative inline-flex items-center" title="هذا الحساب موثق وله مميزات خاصة">
                    <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#1877F2] text-white shadow-[0_0_10px_rgba(24,119,242,0.35)]">
                      <svg viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="none" stroke="currentColor" strokeWidth="3.2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
