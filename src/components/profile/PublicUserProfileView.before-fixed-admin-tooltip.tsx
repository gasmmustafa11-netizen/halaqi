...
export const PublicUserProfileView: React.FC<PublicUserProfileViewProps> = ({
  ...
  <div className="relative inline-flex items-center">
    ...
    <div
      ...
      className="hidden absolute top-8 left-1/2 z-50 w-[calc(100vw-32px)] max-w-[300px] -translate-x-1/2 rounded-xl border border-white/20 bg-white/[0.08] px-3 py-2.5 text-center text-[11px] font-medium leading-5 text-white shadow-[0_12px_40px_rgba(0,0,0,0.25)] backdrop-blur-2xl"
    >
