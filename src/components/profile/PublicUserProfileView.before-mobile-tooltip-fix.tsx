...
export const PublicUserProfileView: React.FC<PublicUserProfileViewProps> = ({
  ...
  <div className="relative inline-flex items-center">
    ...
    <div
      ...
      className="hidden absolute top-7 right-0 z-50 w-max max-w-[260px] rounded-lg border border-white/20 bg-white/[0.08] px-3 py-2 text-[11px] leading-5 text-white shadow-[0_12px_40px_rgba(0,0,0,0.25)] backdrop-blur-2xl"
    >
